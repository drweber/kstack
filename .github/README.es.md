...
Las instalaciones locales reflejan esta estructura bajo el directorio del proyecto (p. ej., `<project>/.codex/skills/`) y solo se detectan cuando el agente se ejecuta desde dentro de ese directorio.
